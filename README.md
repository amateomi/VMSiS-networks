...
- Host-based (программные решения на базе универсальных ОС (Windows, дистрибутивы Linux, Android) работающий на обычном аппаратном обеспечении. Могут реализовываться на уровне ядра ОС и на прикладном уровне)
...
редакциях Windows в составе Routing and Remove Access.

Кроме того, очень широко применяют пакеты сторонних производителей.

## 85. Пакет IP Tables

TP Tables - стандартная пакет в Linux, позволяющий осуществлять настройку
...
Де-факто стандартным прокси-сервером в ОС семейства UNIX, Linux, в том числе,
